...
public class PostagCRFPP extends CRFModel{
    ...
    static {
        ...
        validPostagSet.add("DT");
        validPostagSet.add("ETC");
        validPostagSet.add("IJ");
...
//                    System.out.println(tagger.yname(j)+":"+tagger.prob(i,j));
                    if (tagger.prob(i,j)>bestPorba && j!=28){
                        tagIndex = j;
