...
//        String pupattern = "[|+——！/\\-，。？、~@#￥%……&*（）℃”“()》《丨\"\\[\\]]{1}";
        ...
        String spcpattern = "[\\s]+";
        String bookpattern = "《[\\w\\W\\d\\D]{1,10}》";
        String urlpattern = "(www.*.com){1,}";
        String stockpattern = "\\d{5}.HK";

        String allpattern =  UtilFns.join("|",new String[]{
                        urlpattern,bookpattern,stockpattern,
                numpattern,engpattern,SmoothNLP.SegmentPUPattern,spcpattern,
...
//            System.out.println(matcher.end());
    ...
    public static void main(String[] args){
        ...
        System.out.println(s.process("证券时报网（www.stcn.com）05月12日讯据证券日报报道，近期，地方资产管理公司（AMC）和银行系资管公司扩容均有提速之势。"));
